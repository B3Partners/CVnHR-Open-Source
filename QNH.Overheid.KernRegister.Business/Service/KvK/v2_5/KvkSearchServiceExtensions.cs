    ...
    public static class KvkSearchServiceExtensions
    {
        ...
        public static void SetRaadpleegInformatie(this KvkInschrijving kvkInschrijving, MaatschappelijkeActiviteitType maatschappelijkeActiviteit)
        {
            ...
            if(bijzToestand != null)
            {
                ...
                if (uitspraak != null)
                {
                    kvkInschrijving.RechterlijkeUitspraak = $"{uitspraak.datumUitspraak}: {uitspraak.naam}, {uitspraak.plaats}";
                }
            ...
            if (beperking != null)
            {
                kvkInschrijving.BeperkingInRechtshandeling =
                    $"{beperking.soort} (Rechtelijke uitspraak - datum: {beperking.Item.datumUitspraak}, naam: {beperking.Item.naam}, plaats: {beperking.Item.plaats})";
            }
            else
            ...
            if(eigenaar != null && eigenaar.heeft != null)
                ...
                { 
                    ...
                    functie.FunctieTitel = titel == null
                        ? functie.Functie
                        : $"{titel.functieTitel}, indicatie Statutair: {titel.indicatieStatutair}";
                    ...
                    if (functieVervulling.Item is AansprakelijkeType)
                    {
                        ...
                        if(aansprakelijke.bevoegdheid != null)
                            functie.Bevoegdheid =
                                $"{aansprakelijke.bevoegdheid.soort} (beperking: {(aansprakelijke.bevoegdheid.beperkingInEuros == null ? IndicatieType.Nee.ToString() : aansprakelijke.bevoegdheid.beperkingInEuros.waarde + " " + aansprakelijke.bevoegdheid.beperkingInEuros.valuta)}, overige beperking: {aansprakelijke.bevoegdheid.overigeBeperking})";
                    ...
                    else if (functieVervulling.Item is BestuursfunctieType)
                    {
                        ...
                        if(bestuursFunctie.bevoegdheid != null)
                            functie.Bevoegdheid =
                                $"{bestuursFunctie.bevoegdheid.soort} (met andere personen: {bestuursFunctie.bevoegdheid.bevoegdMetAnderePersonen})";
                        functie.HandelingsBekwaam = IndicatieType.Ja.ToString();
            ...
            if(maatschappelijkeActiviteit.manifesteertZichAls != null)
            {
                ...
                {
                    throw new NotImplementedException("Unknown manifesteerZichAls.registratie " + maatschappelijkeActiviteit.manifesteertZichAls.registratie.GetType());
                    //void
                }
            }
        ...
        public static string SchrijfKapitaalType(this KapitaalType kapitaal)
        {
            ...
            if(kapitaal.aandelen != null)
                result.Append("Aandelen: " + string.Join(" | ", kapitaal.aandelen.Select(k=>
                                  $"{k.aantal} {k.soort} ({k.waarde.valuta})")));
